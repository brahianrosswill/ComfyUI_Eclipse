	...
	def define_schema(cls):
		return io.Schema(
			...
			inputs=[
				...
				io.Boolean.Input("extract_metadata", default=False, tooltip="Extract generation metadata from images (slower). Disable for faster loading."),
				io.Boolean.Input("refresh_list", default=False, tooltip="Force refresh of the cached file list."),
