# Fast Muter - DEPRECATED: Use the Fast Mode Switcher instead.
# Virtual node for toggling mute on connected nodes.
...
class RvTools_FastMuter(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            description="[DEPRECATED — use Fast Mode Switcher] Toggle-mute connected nodes on the canvas.",
            is_deprecated=True,
        )
