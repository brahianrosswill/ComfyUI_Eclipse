import{app}from'./comfy/index.js';import{smartResize,createWidgetVisibilityManager,isConfiguringGraph,}from'./eclipse-widget-performance-utils.js';const NODE_NAME='Lora Stack [Eclipse]';const MODE_OPTIONS=['standard','model_only','simple'];const DEFAULT_MODE='standard';let _cssInjected=false;function injectModeBarCSS(){if(_cssInjected)return;_cssInjected=true;const style=document.createElement('style');style.textContent=`
.eclipse-ls-mode-bar {
