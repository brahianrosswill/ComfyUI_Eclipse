                ...
                c = async () => {
                    ...
                    if ((await l(), 'None' === e))
                        (u('template_name', 'None'),
                            ...
                            u('configure_blockswap', !1),
                            u('blocks_to_swap', 20),
                            u('offload_embeddings', !1),
            ...
            const p = { None: '🔄 Reset Template Fields', Load: '🗑️ Delete Template', Save: '💾 Save Template' },
                    ...
                    if (a) {
                        ...
                        try {
                            ...
                            (u('sampler_name', 'euler'),
                                ...
                                void 0 !== a.configure_blockswap && u('configure_blockswap', a.configure_blockswap),
                                void 0 !== a.blocks_to_swap && u('blocks_to_swap', a.blocks_to_swap),
                                void 0 !== a.offload_embeddings && u('offload_embeddings', a.offload_embeddings),
                ...
                v = () => {
                    ...
                    (d('shift', s && 'None' !== u && !V && !j),
                        ...
                        d('sigma_max', s && j),
                        d('sigma_min', s && j),
                        d('configure_blockswap', !(E || F || L)),
                        d('blocks_to_swap', P && !(E || F || L)),
                        d('offload_embeddings', P && !(E || F || L)),
                        smartResize(n));
                },
                y = debounce(v, 100);
            [
