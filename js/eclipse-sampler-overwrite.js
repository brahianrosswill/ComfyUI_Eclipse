/* eclipse-sampler-overwrite.js - Toggle sampler/scheduler/steps/cfg visibility based on allow_overwrite */
import { app } from './comfy/index.js';
import { smartResize, createWidgetVisibilityManager } from './eclipse-widget-performance-utils.js';

const SAMPLER_OVERWRITE_NODES = [
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            const updateVisibility = () => {
                ...
                smartResize(node, { minWidth: 0, minHeight: 0, padding: 0 });
            };
            ...
            setTimeout(() => {
                node._Eclipse_overwriteInit || ((node._Eclipse_overwriteInit = true), updateVisibility());
            }, 0);
