...
const NODE_NAME = 'Smart Loader v2 [Eclipse]';
                ...
                c = async () => {
                    ...
                    if ((await l(), 'None' === e))
                        (d('template_name', 'None'),
                            ...
                            d('configure_blockswap', !1),
                            d('blocks_to_swap', 10),
                            d('offload_embeddings', !1),
                        ...
                        const e = t.trim(),
                            a = (() => {
                                ...
                                if (
                                    ...
                                    (e.configure_blockswap = g('configure_blockswap')),
                                    (e.blocks_to_swap = g('blocks_to_swap')),
                                    (e.offload_embeddings = g('offload_embeddings')),
            ...
            const p = { None: '🔄 Reset Template Fields', Load: '🗑️ Delete Template', Save: '💾 Save Template' },
                    ...
                    if (a) {
                        ...
                        try {
                            ...
                            (void 0 !== a.model_type && d('model_type', a.model_type),
                                ...
                                void 0 !== a.configure_blockswap && d('configure_blockswap', a.configure_blockswap),
                                void 0 !== a.blocks_to_swap && d('blocks_to_swap', a.blocks_to_swap),
                                void 0 !== a.offload_embeddings && d('offload_embeddings', a.offload_embeddings),
                ...
                v = () => {
                    ...
                    (r('shift', _ && 'None' !== l && !W && !D),
                        ...
                        r('sigma_max', _ && D),
                        r('sigma_min', _ && D),
                        r('configure_blockswap', !(N || b || k)),
                        r('blocks_to_swap', P && !(N || b || k)),
                        r('offload_embeddings', P && !(N || b || k)),
                        smartResize(n));
                },
                y = debounce(v, 100);
            [
