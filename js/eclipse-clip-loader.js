/* eclipse-clip-loader.js - Widget visibility for CLIP Loader [Eclipse] */
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, _app) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            // Cache original clip file lists
            const origClipLists = {};
            ...
            const updateVisibility = () => {
                ...
                // Preserve original lists for clip dropdowns
            ...
            // Fetch fresh CLIP file lists from server
